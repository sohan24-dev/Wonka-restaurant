...
const TotalPrice = ({ allitems }) => {
    ...
    const totalPrice = Array.isArray(allitems) ? allitems.reduce((sum, order) => {
    ...
    return (
        <div>
            {totalPrice > 0 ? (
                <div className="mx-4 my-6 p-5 rounded-2xl bg-gradient-to-r from-orange-50 to-white shadow-lg border border-orange-100 flex items-center justify-between">
                    <div>
                ...
                <div className="flex flex-col items-center justify-center py-16 px-6 text-center bg-white rounded-2xl shadow-sm border mx-4 my-6">
                    <div className="text-5xl mb-4">🍽️</div>
                    <h2 className="text-2xl font-bold text-gray-800">No Orders Yet</h2>
                    <p className="text-gray-500 mt-2 max-w-md">
                        You haven’t placed any orders yet. Discover delicious meals and start your first order now.
                    </p>
                    <Link href="/allitems">
