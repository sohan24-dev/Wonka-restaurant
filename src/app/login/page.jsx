        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 px-4">
            ...
            >
                <Fieldset>
                    ...
                    <Fieldset.Actions className="flex flex-col sm:flex-row gap-3 mt-8">
                        <Button
                            type="submit"
                    ...
                    <Button
                        type="button"
                        className="w-full flex items-center justify-center gap-2 border border-gray-100 py-3 rounded-xl hover:bg-gray-500 transition"
